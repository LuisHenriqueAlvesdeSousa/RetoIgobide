        ...
        connectedCallback(){
            ...
            <div class="tecnicosOpc2">
                <div class="imagenTecn">
                    <svg onclick="window.open(`${this.getAttribute("ruta")}`)" xmlns="http://www.w3.org/2000/svg" width="4pc" height="4.1pc" fill="currentColor" class="bi bi-info" viewBox="0 0 16 16">
