...
<head>
    ...
    <script src="{{ url('https://cdn.jsdelivr.net/npm/sweetalert2@11.3.10/dist/sweetalert2.all.min.js') }}"></script>
        ...
        <ul>
            ...
            <li>
                <div class="opNewOperario2">
                    ...
                    <input type="text" class="opNewOperarioComentario">
                </div>
            </li>
            ...
            <li>
                <div class="container">
                    <div class="opNewOperario2 lineal">
                        <a class="titulo">Tipo Instalacion</a><br>
