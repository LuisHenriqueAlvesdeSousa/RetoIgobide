        ...
        connectedCallback(){
            ...
            <div class="tecnicosOpc2">
                <div class="imagenTecn">
                    <svg onclick="window.location.href=this.getAttribute('ruta')" ruta="${this.getAttribute('ruta')}" class="opc"xmlns="http://www.w3.org/2000/svg" width="4pc" height="4.1pc" fill="currentColor" class="bi bi-info" viewBox="0 0 16 16">
                ...
                <div class="opciones">
                    <ul>
                        <li>
                            <form action="window.location.href='./eliminar/' + this.id" id="${this.getAttribute('idmanual')}">
                            {{ method_field('DELETE') }}
                                <input type="submit" style="display:none">
                                <svg onclick="window.location.href='./eliminar/' + this.id" id="${this.getAttribute('idmanual')}" class="opc" xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
...
<body>
                ...
                <div class="manOpc">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item">Manuales</li>
                        </ol>
                      </nav>
                </div>
            </li>
            <li><div class="manOpc subMan">
                                <form method="POST" action="{{route('manuales.subir')}}" accept-charset="UTF-8" enctype="multipart/form-data">
                {{ csrf_field() }}
                <label for="archivo">
                        <b>Nuevo manual: </b>
                    </label><br>
    ...
    <script>
        ...
        success: function(data) {
            ...
            elemento.setAttribute("idManual",data[i]["manual_id"]);
