        ...
        connectedCallback(){
            ...
            <div class="tecnicosOpc2">
                <div class="imagenTecn">
                    <svg onclick="window.location.href=this.getAttribute('ruta')" ruta="${this.getAttribute('ruta')}" xmlns="http://www.w3.org/2000/svg" width="4pc" height="4.1pc" fill="currentColor" class="bi bi-info" viewBox="0 0 16 16">
                ...
                <div class="opciones">
                    <ul>
                        <li>
                            <svg onclick="window.location.href='./eliminarManual/' + this.id" id="${this.getAttribute('idmanual')}" xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
