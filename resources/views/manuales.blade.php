        ...
        connectedCallback(){
            ...
            <div class="tecnicosOpc2">
                ...
                <div class="opciones">
                    <ul>
                        <li>
                            <svg onclick="alert('/eliminar/this.getAttribute("id")')" id="${this.getAttribute('id')}" xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
